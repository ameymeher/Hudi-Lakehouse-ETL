...
def setup_logging(default_path='logging.yaml', default_level=logging.INFO):
    ...
    if path.exists():
        ...
        print(f"Logging configuration file {path} not found. Using default level {default_level}.")
...
def execute_spark_submit_parallel(spark_submit_command):
    try:
        ...
        logger.info("Spark SUBMIT command executed successfully.")
    except subprocess.CalledProcessError as e:
        logger.error(f"Error executing Spark SUBMIT command: {e}")
